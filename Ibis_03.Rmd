...
We combine real and simulated data for illustration.  Model 

the number of hospital or ER visits for patients, and subsequently cost and other statistics of interest, at both population and patient levels, across Ibis users vs non-users in given time period using data such as 
